...
![img/459821_1_En_2_Figa_HTML.jpg](img/459821_1_En_2_Figa_HTML.jpg)
...
This first code sequence flow written in the origami DSL is shown in Figure 2-2.![img/459821_1_En_2_Fig2_HTML.gif](img/459821_1_En_2_Fig2_HTML.gif) Figure 2-2
...
 lein run -m opencv3.videosample When the command starts, you will be presented with a moving view of the coffee shop you are typing those few lines of code in, just as in Figure 2-3.![img/459821_1_En_2_Fig3_HTML.jpg](img/459821_1_En_2_Fig3_HTML.jpg) Figure 2-3
...
(defn -main [& args]     (->      (imread "resources/cat.jpg")      (cvt-color! COLORMAP_JET)      (imwrite "jet-neko.jpg")      (println "A new jet neko has arisen!"))) You can see a new file jet-neko.jpg created and a new fun-looking cat, as in Figure 2-4.![img/459821_1_En_2_Fig4_HTML.jpg](img/459821_1_En_2_Fig4_HTML.jpg) Figure 2-4
...
(require '[opencv3.utils :as u]) (u/show (imread "resources/minicat.jpg")) The cute cat from Figure 2-5 should now be showing up on your computer as well.![img/459821_1_En_2_Fig5_HTML.jpg](img/459821_1_En_2_Fig5_HTML.jpg) Figure 2-5

可爱的猫

Origami 艺术鼓励图像处理流水线的概念。因此，要读取图像，转换加载图像的颜色，并在一个帧中显示结果图像，您通常会使用 Clojure 线程宏-->，一个接一个地流水线化所有的函数调用，就像下面的一行程序一样:

(-> "resources/minicat.jpg" imread (cvt-color! COLOR_RGB2GRAY) (u/show)) Which now converts the minicat.jpg from Figure 2-5 to its gray version as in Figure 2-6.![img/459821_1_En_2_Fig6_HTML.jpg](img/459821_1_En_2_Fig6_HTML.jpg) Figure 2-6
...
to get the same setup on your atom editor, as shown in Figure 2-7.![img/459821_1_En_2_Fig7_HTML.jpg](img/459821_1_En_2_Fig7_HTML.jpg) Figure 2-7

在 Atom 中安装两个插件:ink 和 proto-repl

The same Leiningen-based REPL can be started either by the atom menu as in Figure 2-8 or by the equivalent key shortcut.![img/459821_1_En_2_Fig8_HTML.jpg](img/459821_1_En_2_Fig8_HTML.jpg) Figure 2-8

从 Atom 内部启动 REPL

启动 REPL 时，Atom 编辑器的右侧会打开一个名为 Proto-REPL 的窗口。这与您直接从终端执行 **lein repl** 命令时使用的 REPL 完全相同。所以，你也可以在那里输入代码。

But the real gem of this setup is to have autocompletion and choice presented to you when typing code, as in Figure 2-9.![img/459821_1_En_2_Fig9_HTML.jpg](img/459821_1_En_2_Fig9_HTML.jpg) Figure 2-9

即时完成

You can now retype the code to read and convert the color of an image directly in a file , let’s say **ok.clj**. Your setup should now be similar to that shown in Figure 2-10.![img/459821_1_En_2_Fig10_HTML.jpg](img/459821_1_En_2_Fig10_HTML.jpg) Figure 2-10
...
After code evaluation, and a slight tab arrangement, you can have instant code writing on the left-hand side, and the image transformation feedback on the right-hand side, just as in Figure 2-11.![img/459821_1_En_2_Fig11_HTML.jpg](img/459821_1_En_2_Fig11_HTML.jpg) Figure 2-11
...
You will be presented with a worksheet like in Figure 2-12.![img/459821_1_En_2_Fig12_HTML.jpg](img/459821_1_En_2_Fig12_HTML.jpg) Figure 2-12

大猩猩笔记本和一只猫

In a gorilla notebook , every block of the page is either Clojure code or markdown text. You can turn the currently highlighted block to text mode by using Alt+g, Alt+m (or Ctrl+g, Ctrl+m on Mac) where m is for markdown, as in Figure 2-13.![img/459821_1_En_2_Fig13_HTML.jpg](img/459821_1_En_2_Fig13_HTML.jpg) Figure 2-13

降价文本模式

You can also turn back the highlighted block into code mode by using Alt+g, Alt+j (or Ctrl+g, Ctrl+j on Mac), where j is for Clo**j**ure, as in Figure 2-14.![img/459821_1_En_2_Fig14_HTML.jpg](img/459821_1_En_2_Fig14_HTML.jpg) Figure 2-14

代码块

To execute the highlighted block of code , you would use Shift+Enter, and the block turns into executed mode, as in Figure 2-15.![img/459821_1_En_2_Fig15_HTML.jpg](img/459821_1_En_2_Fig15_HTML.jpg) Figure 2-15
...
(-> "http://eskipaper.cimg/jump-cat-1.jpg"  (u/mat-from-url)  (u/resize-by 0.3)  (u/mat-view)) And now… **Shift+Enter**! This should bring you close to Figure 2-16 and a new shot of instant gratification .![img/459821_1_En_2_Fig16_HTML.jpg](img/459821_1_En_2_Fig16_HTML.jpg) Figure 2-16
...
(def mat (new-mat 30 30 CV_8UC1)) If you try to display the content of the mat, either with u/mat-view (gorilla repl) or u/show (standard repl), then the memory assigned to the mat is actually left as is. See Figure 2-17.![img/459821_1_En_2_Fig17_HTML.jpg](img/459821_1_En_2_Fig17_HTML.jpg) Figure 2-17

没有指定颜色的新垫子

让我们指定一种颜色，对垫子的每个像素都一样。这可以在创建垫子时完成，**或**可以通过**设置为**来完成，这是对**的调用。OpenCV 的 Java 函数 setTo** 。

(def mat (new-mat 30 30 CV_8UC1 (new-scalar 105))) ; or (def mat (new-mat 30 30 CV_8UC1)) (set-to mat (new-scalar 105)) Every pixel in the mat now has value 105 assigned to it (Figure 2-18).![img/459821_1_En_2_Fig18_HTML.jpg](img/459821_1_En_2_Fig18_HTML.jpg) Figure 2-18
...
(def green-mat  (new-mat 30 30 CV_8UC3 (new-scalar 0 255 0))) (def blue-mat   (new-mat 30 30 CV_8UC3 (new-scalar 255 0 0))) If you execute all this in the gorilla REPL, each of the mats shows up, as in Figure 2-19.![img/459821_1_En_2_Fig19_HTML.jpg](img/459821_1_En_2_Fig19_HTML.jpg) Figure 2-19
...
(def mat (new-mat 30 30 CV_8UC3 (new-scalar 255 255 0))) (def sub (submat mat (new-rect 10 10 10 10))) (set-to sub (new-scalar 0 255 255)) The resulting main mat, with yellow inside where the submat was defined, and the rest of the mat in cyan color, is shown in Figure 2-20.![img/459821_1_En_2_Fig20_HTML.jpg](img/459821_1_En_2_Fig20_HTML.jpg) Figure 2-20

用 Origami 提交

在这个阶段，看看一行 Origami 代码能做什么，通过使用 **hconcat！**，一个将多个地垫连接在一起的函数，以及 **clojure.core/repeat** ，创建一个相同项目的序列。

(u/mat-view (hconcat! (clojure.core/repeat 10 mat3))) The resulting pattern is shown in Figure 2-21.![img/459821_1_En_2_Fig21_HTML.jpg](img/459821_1_En_2_Fig21_HTML.jpg) Figure 2-21
...
(def height 100) (def width 100) (def a (new-mat height width CV_8UC3)) (doseq [x (range width)         y (range height)]   (.put a x y (byte-array [0 0 (rand 255)]))) Figure 2-22 gives one version of the executed snippet.![img/459821_1_En_2_Fig22_HTML.jpg](img/459821_1_En_2_Fig22_HTML.jpg) Figure 2-22
...
*   Finally, we can view the generated mat (Figure 2-23).![img/459821_1_En_2_Fig23_HTML.jpg](img/459821_1_En_2_Fig23_HTML.jpg) Figure 2-23
...
*   u/mat-view displays the mat (Figure 2-24) in the gorilla REPL![img/459821_1_En_2_Fig24_HTML.jpg](img/459821_1_En_2_Fig24_HTML.jpg)
...
 (->> (range 25)       (map #(new-mat 30 30 CV_8UC1 (new-scalar (double (* % 10)))))       (hconcat!)       (u/mat-view)) ![img/459821_1_En_2_Fig25_HTML.jpg](img/459821_1_En_2_Fig25_HTML.jpg) Figure 2-25

25 个垫的灰色渐变

您还可以通过生成 255 个值的范围来使事情变得平滑，并使创建的垫子稍微小一些，每个垫子的大小为 2×10(图 2-26 )。

(->> (range 255)      (map #(new-mat 20 2 CV_8UC1 (new-scalar (double %))))      (hconcat!)      (u/mat-view)) ![img/459821_1_En_2_Fig26_HTML.jpg](img/459821_1_En_2_Fig26_HTML.jpg) Figure 2-26
...
The resulting loaded Mat object is shown in Figure 2-27.![img/459821_1_En_2_Fig27_HTML.jpg](img/459821_1_En_2_Fig27_HTML.jpg) Figure 2-27
...
(-> "resources/kitten.jpg"     (imread IMREAD_REDUCED_GRAYSCALE_4)     (u/mat-view)) It loads the same picture, but the mat looks different this time , as its color has been converted, like in Figure 2-28.![img/459821_1_En_2_Fig28_HTML.jpg](img/459821_1_En_2_Fig28_HTML.jpg) Figure 2-28
...
(imwrite mat "grey-neko.png") A new file, **grey-neko.png** , will be created from the loaded mat object (Figure 2-29).![img/459821_1_En_2_Fig29_HTML.jpg](img/459821_1_En_2_Fig29_HTML.jpg) Figure 2-29
...
(-> "resources/kitten.jpg"     (imread)     (u/imshow)) The **imshow** function takes a mat as the parameter and opens a Java frame with the mat inside, as shown in Figure 2-30.![img/459821_1_En_2_Fig30_HTML.jpg](img/459821_1_En_2_Fig30_HTML.jpg) Figure 2-30
...
Figure 2-31 shows the mat after pressing u.![img/459821_1_En_2_Fig31_HTML.jpg](img/459821_1_En_2_Fig31_HTML.jpg) Figure 2-31

深色猫

Figure 2-32 shows the mat after pressing v.![img/459821_1_En_2_Fig32_HTML.jpg](img/459821_1_En_2_Fig32_HTML.jpg) Figure 2-32
...
(-> "http://www.hellonico.info/static/cat-peekaboo.jpg"     (u/mat-from-url)     (u/mat-view)) And the resulting image is shown in Figure 2-33.![img/459821_1_En_2_Fig33_HTML.jpg](img/459821_1_En_2_Fig33_HTML.jpg) Figure 2-33
...
(-> "http://www.hellonico.info/static/cat-peekaboo.jpg"     (u/mat-from-url IMREAD_REDUCED_GRAYSCALE_4)     (u/mat-view)) The same remote picture is now both smaller and loaded in black and white, as shown in Figure 2-34.![img/459821_1_En_2_Fig34_HTML.jpg](img/459821_1_En_2_Fig34_HTML.jpg) Figure 2-34
...
So, if you want to use a red color , you can get your environment to help you find and autocomplete the scalar you are looking for, as shown in Figure 2-35.![img/459821_1_En_2_Fig35_HTML.jpg](img/459821_1_En_2_Fig35_HTML.jpg) Figure 2-35
...
(->> (html/->scalar "#66cc77")      (new-mat 20 20 CV_8UC3 )      (u/mat-view )) which creates a small mat of a light green/blue color (Figure 2-36).![img/459821_1_En_2_Fig36_HTML.jpg](img/459821_1_En_2_Fig36_HTML.jpg) Figure 2-36
...
To apply the map to a Mat, for example the cat from Figure 2-37, simply use the apply-color-map! function .![img/459821_1_En_2_Fig37_HTML.jpg](img/459821_1_En_2_Fig37_HTML.jpg) Figure 2-37

要上色的猫

下面的代码片段显示了如何依次使用通常的 imread 和 apply-color-map。

(-> "resources/cat-on-sofa.jpg"     (imread IMREAD_REDUCED_COLOR_4)     (apply-color-map! COLORMAP_AUTUMN)     (u/mat-view)) The resulting cat is shown in Figure 2-38.![img/459821_1_En_2_Fig38_HTML.jpg](img/459821_1_En_2_Fig38_HTML.jpg) Figure 2-38
...
(def sepia-2 (u/matrix-to-mat [   [0.131 0.534 0.272]   [0.168 0.686 0.349]   [0.189 0.769 0.393]])) (-> "resources/cat-on-sofa.jpg"    (imread IMREAD_REDUCED_COLOR_4)    (transform! sepia-2) (u/mat-view )) With the resulting sepia cat in Figure 2-39.![img/459821_1_En_2_Fig39_HTML.jpg](img/459821_1_En_2_Fig39_HTML.jpg) Figure 2-39
...
(-> (new-mat 1 1 CV_8UC3 rgb/red-2)     (.dump)) ; "[  0,   0, 238]" (-> (new-mat 30 30 CV_8UC3 rgb/red-2)     (u/mat-view)) ![img/459821_1_En_2_Fig40_HTML.jpg](img/459821_1_En_2_Fig40_HTML.jpg) Figure 2-40

RGB 颜色空间中的红色

但是，当您更改颜色空间并将其转换到另一个名称空间时，比如 HSV，Hue-Saturation-Value，矩阵的值会发生变化。

(-> (new-mat 1 1 CV_8UC3 rgb/red-2)     (cvt-color! COLOR_RGB2HSV)     (.dump)) (-> (new-mat 30 30 CV_8UC3 rgb/red-2)     (cvt-color! COLOR_RGB2HSV)     (u/mat-view)) And of course, the simple display of the mat content is not really relevant anymore; as shown in Figure 2-41, it turned to yellow!!![img/459821_1_En_2_Fig41_HTML.jpg](img/459821_1_En_2_Fig41_HTML.jpg) Figure 2-41
...
(->> (range 255)      (map #(new-mat 20 1 CV_8UC3 (new-scalar % % 255)))      (hconcat!)      (u/mat-view)) That shows the line of Figure 2-42.![img/459821_1_En_2_Fig42_HTML.jpg](img/459821_1_En_2_Fig42_HTML.jpg) Figure 2-42
...
(->> (range 180)      (map hsv-mat)      (hconcat!)      (u/mat-view)) The drawn result is shown in Figure 2-43.![img/459821_1_En_2_Fig43_HTML.jpg](img/459821_1_En_2_Fig43_HTML.jpg) Figure 2-43
...
Because it can be annoying to select red in one range, you can sometimes use the reverse RGB during the color conversion: instead of using COLOR_BGR2HSV, you can try to use COLOR_RGB2HSV (Figure 2-44).![img/459821_1_En_2_Fig44_HTML.jpg](img/459821_1_En_2_Fig44_HTML.jpg) Figure 2-44
...
(-> "resources/redcat.jpg"     (imread IMREAD_REDUCED_COLOR_2)     (u/mat-view)) ![img/459821_1_En_2_Fig45_HTML.jpg](img/459821_1_En_2_Fig45_HTML.jpg) Figure 2-45
...
(def mask (new-mat)) (-> "resources/redcat.jpg"     (imread IMREAD_REDUCED_COLOR_2)     (cvt-color! COLOR_RGB2HSV)     (in-range lower-red upper-red mask)) (u/mat-view mask) Et voila: the resulting mask mat is in Figure 2-46.![img/459821_1_En_2_Fig46_HTML.jpg](img/459821_1_En_2_Fig46_HTML.jpg) Figure 2-46
...
(def neko (imread "resources/ai3.jpg" IMREAD_REDUCED_COLOR_8)) (u/mat-view neko) ![img/459821_1_En_2_Fig47_HTML.jpg](img/459821_1_En_2_Fig47_HTML.jpg) Figure 2-47
...
(->  neko      (clone)      (flip! 0)      (u/mat-view)) And the result is shown in Figure 2-48.![img/459821_1_En_2_Fig48_HTML.jpg](img/459821_1_En_2_Fig48_HTML.jpg) Figure 2-48
...
(->> [1 -1 0]      (map #(-> neko clone (flip! %)))      (hconcat!)      (u/mat-view)) This time, all the flips are showing (Figure 2-49).![img/459821_1_En_2_Fig49_HTML.jpg](img/459821_1_En_2_Fig49_HTML.jpg) Figure 2-49
...
(->  neko      (clone)      (rotate! ROTATE_90_CLOCKWISE)      (u/mat-view)) Note again the use of clone to create an intermediate mat in the processing flow, and the result in Figure 2-50.![img/459821_1_En_2_Fig50_HTML.jpg](img/459821_1_En_2_Fig50_HTML.jpg) Figure 2-50

顺时针旋转的猫

还要注意如何使用 clone 和--> >从一个源创建多个垫子。

(->> [ROTATE_90_COUNTERCLOCKWISE ROTATE_90_CLOCKWISE]      (map #(-> neko clone (rotate! %)))      (hconcat!)      (u/mat-view)) In the final step, the multiple mats are concatenated using **hconcat!** (Figure 2-51) or **vconcat!** (Figure 2-52).![img/459821_1_En_2_Fig51_HTML.jpg](img/459821_1_En_2_Fig51_HTML.jpg) Figure 2-51

使用 hconcat！在旋转垫上

![img/459821_1_En_2_Fig52_HTML.jpg](img/459821_1_En_2_Fig52_HTML.jpg) Figure 2-52
...
(warp-affine! img matrix (.size img)) (u/mat-view img) And the 45-degrees-rotated cat is shown in Figure 2-53.![img/459821_1_En_2_Fig53_HTML.jpg](img/459821_1_En_2_Fig53_HTML.jpg) Figure 2-53
...
(->> (range 0 360 40)      (map #(-> neko clone (rotate-by! % )))      (hconcat!)      (u/mat-view)) And the fun concatenated mats are shown in Figure 2-54.![img/459821_1_En_2_Fig54_HTML.jpg](img/459821_1_En_2_Fig54_HTML.jpg) Figure 2-54
...
(->> (range 7)      (map (fn[_] (-> neko clone (rotate-by! 0 (rand 5)))))      (hconcat!)      (u/mat-view)) And the result is shown in Figure 2-55. Also note that when the zoom value is too small, default black borders can be seen in the resulting small mat.![img/459821_1_En_2_Fig55_HTML.jpg](img/459821_1_En_2_Fig55_HTML.jpg) Figure 2-55
...
(-> neko clone (warp-affine! transform-mat (.size neko)) u/mat-view) Figure 2-56 shows the result of the affine transformation .![img/459821_1_En_2_Fig56_HTML.jpg](img/459821_1_En_2_Fig56_HTML.jpg) Figure 2-56
...
We then use a new cat picture (Figure 2-57).![img/459821_1_En_2_Fig57_HTML.jpg](img/459821_1_En_2_Fig57_HTML.jpg) Figure 2-57

美丽的法国猫

只需将我们的功能付诸行动。参数中的值 0 意味着除了蓝色通道之外的所有通道都将被设置为 0。

(->   "resources/emilie1.jpg"   (imread)   **(filter-buffer! 0)**   (u/mat-view)) And yes, the resulting picture is overly blue (Figure 2-58).![img/459821_1_En_2_Fig58_HTML.jpg](img/459821_1_En_2_Fig58_HTML.jpg) Figure 2-58

蓝猫

在这里，我们再次使用 Clojure 代码生成功能，在通道范围内创建所有三个 mat 的串联 mat(图 2-59 )。

(def source     (imread "resources/emilie1.jpg")) (->> (range 0 3)      (map #(filter-buffer! (clone source) %))      (hconcat!)      (u/mat-view)) ![img/459821_1_En_2_Fig59_HTML.jpg](img/459821_1_En_2_Fig59_HTML.jpg) Figure 2-59
...
(->   "resources/emilie1.jpg"   (imread)   (multiply! (u/matrix-to-mat-of-double [ [1.0 0.5 0.0]] ))   (u/mat-view)) ![img/459821_1_En_2_Fig60_HTML.jpg](img/459821_1_En_2_Fig60_HTML.jpg) Figure 2-60
...
 (def img (->   "resources/emilie1.jpg"   (imread))) (-> img   (submat (new-rect 100 50 100 100))   (cvt-color! COLOR_RGB2HLS)   (multiply! (u/matrix-to-mat-of-double [ [1.0 1.3 1.3]] ))   (cvt-color! COLOR_HLS2RGB)) (u/mat-view img) The resulting highlight mat is shown in Figure 2-62.![img/459821_1_En_2_Fig62_HTML.jpg](img/459821_1_En_2_Fig62_HTML.jpg) Figure 2-62
...
(-> "resources/emilie4.jpg"     (imread)     (filter-2-d! -1 (u/matrix-to-mat       [[0 0 0]        [0 1 0]        [0 0 0]]))     (u/mat-view)) This does nothing! Great. We all want more of that. The filter-2-d function call really just keeps the image as is, as shown in Figure 2-63.![img/459821_1_En_2_Fig63_HTML.jpg](img/459821_1_En_2_Fig63_HTML.jpg) Figure 2-63

未受干扰的猫

让我们回到矩阵和原始像素值上来，通过一个简单的灰色矩阵的例子，更好地理解事情是如何进行的。

(def m (new-mat 100 100 CV_8UC1 (new-scalar 200.0))) The preceding snippet, as you know by now, creates a small 100×100 gray mat (Figure 2-64).![img/459821_1_En_2_Fig64_HTML.jpg](img/459821_1_En_2_Fig64_HTML.jpg) Figure 2-64
...
(def s (submat m (new-rect 10 10 50 50))) (filter-2-d! s -1     (u/matrix-to-mat       [[0 0 0]        [0 0.25 0]        [0 0 0]])) Here, that means the entire submat will be darker than the pixels not located in the submat, as confirmed in Figure 2-65.![img/459821_1_En_2_Fig65_HTML.jpg](img/459821_1_En_2_Fig65_HTML.jpg) Figure 2-65
...
(-> "resources/emilie4.jpg"   (imread)   (cvt-color! COLOR_BGR2GRAY)   (threshold! 150 250 THRESH_BINARY_INV)   (u/mat-view)) Figure 2-67 shows the resulting mat after applying the threshold to my sister’s white cat.![img/459821_1_En_2_Fig67_HTML.jpg](img/459821_1_En_2_Fig67_HTML.jpg) Figure 2-67
...
Figure 2-68 shows the result of the adaptive threshold.![img/459821_1_En_2_Fig68_HTML.jpg](img/459821_1_En_2_Fig68_HTML.jpg) Figure 2-68
...
(def rose   (-> "resources/red_rose.jpg"       (imread IMREAD_REDUCED_COLOR_2))) (u/mat-view rose) Figure 2-69 shows the flower that will be the source of this exercise.![img/459821_1_En_2_Fig69_HTML.jpg](img/459821_1_En_2_Fig69_HTML.jpg) Figure 2-69
...
(def hsv   (-> rose clone (cvt-color! COLOR_RGB2HSV))) (u/mat-view hsv) ![img/459821_1_En_2_Fig70_HTML.jpg](img/459821_1_En_2_Fig70_HTML.jpg) Figure 2-70
...
The resulting mask is shown in Figure 2-71.![img/459821_1_En_2_Fig71_HTML.jpg](img/459821_1_En_2_Fig71_HTML.jpg) Figure 2-71

红玫瑰的面具

掩码现在可以和**一起使用了！**原始源上升，因此我们只复制蒙版 mat 值不等于 0 的像素。

(def res (new-mat)) (bitwise-and! rose res mask) (u/mat-view res) And now you have a resulting mat (Figure 2-72) of only the red part of the picture.![img/459821_1_En_2_Fig72_HTML.jpg](img/459821_1_En_2_Fig72_HTML.jpg) Figure 2-72
...
(def res2 (new-mat)) (convert-to res res2 -1 1 100) (u/mat-view res2) The resulting masked rose is a slightly brighter version of the original rose (Figure 2-73).![img/459821_1_En_2_Fig73_HTML.jpg](img/459821_1_En_2_Fig73_HTML.jpg) Figure 2-73

明亮的玫瑰

让我们把产生的亮玫瑰复制回原图，或者是它的复制品(图 2-74 )。

(def cl (clone rose)) (copy-to res2 cl mask) (u/mat-view cl) ![img/459821_1_En_2_Fig74_HTML.jpg](img/459821_1_En_2_Fig74_HTML.jpg) Figure 2-74
...
(def cl3   (clone rose)) (copy-to cl2 cl3 mask) (u/mat-view cl3) The cat mat is thus copied onto the rose, but only where the mask allows the copy to happen (Figure 2-75).![img/459821_1_En_2_Fig75_HTML.jpg](img/459821_1_En_2_Fig75_HTML.jpg) Figure 2-75
...
(def neko   (-> "resources/emilie5.jpg"       (imread)       (u/resize-by 0.07))) (u/mat-view neko) Figure 2-76 shows another picture of my sister’s cat.![img/459821_1_En_2_Fig76_HTML.jpg](img/459821_1_En_2_Fig76_HTML.jpg) Figure 2-76
...
(-> neko     (clone)     (blur! (new-size 3 3))     (u/mat-view)) The result can be seen in Figure 2-77.![img/459821_1_En_2_Fig77_HTML.jpg](img/459821_1_En_2_Fig77_HTML.jpg) Figure 2-77
...
(->> (range 3 10 2)      (map #(-> neko  clone (u/resize-by 0.5) (blur! (new-size % %))))      (hconcat!)      (u/mat-view)) ![img/459821_1_En_2_Fig78_HTML.jpg](img/459821_1_En_2_Fig78_HTML.jpg) Figure 2-78
...
(-> neko clone (gaussian-blur! (new-size 5 5) 17) (u/mat-view)) The result of the gaussian blur is shown in Figure 2-79.![img/459821_1_En_2_Fig79_HTML.jpg](img/459821_1_En_2_Fig79_HTML.jpg) Figure 2-79
...
(-> neko     clone     (bilateral-filter! 9 9 7)     (u/mat-view)) ![img/459821_1_En_2_Fig80_HTML.jpg](img/459821_1_En_2_Fig80_HTML.jpg) Figure 2-80
...
(-> neko     clone     (cvt-color! COLOR_BGR2GRAY)     (bilateral-filter! 9 9 7)     (canny! 50.0 250.0 3 true)     (bitwise-not!)     (u/mat-view)) ![img/459821_1_En_2_Fig81_HTML.jpg](img/459821_1_En_2_Fig81_HTML.jpg) Figure 2-81

高斯模糊和精明

第三个例子快速展示了为什么你想使用双边过滤器，而不是简单的模糊。我们保持同样的小处理流水线，但这次使用简单的模糊，而不是双边过滤器。

    (-> neko       clone       (cvt-color! COLOR_BGR2GRAY)       (blur! (new-size 3 3))       (canny! 50.0 250.0 3 true)       (bitwise-not!)       (u/mat-view)) The output clearly highlights the problem: defining lines have disappeared, and Figure 2-82 shows a disappearing cat …![img/459821_1_En_2_Fig82_HTML.jpg](img/459821_1_En_2_Fig82_HTML.jpg) Figure 2-82
...
It is less useful for shape detection, as seen in Figures 2-83 and 2-84, but still combines with other mats for creative impact, as we will see in chapter 3.![img/459821_1_En_2_Fig83_HTML.jpg](img/459821_1_En_2_Fig83_HTML.jpg) Figure 2-83

艺术猫(内核长度 31)

![img/459821_1_En_2_Fig84_HTML.jpg](img/459821_1_En_2_Fig84_HTML.jpg) Figure 2-84
